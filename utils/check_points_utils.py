...
def save_checkpoint(filename, model_3d=None, model_2d=None, optimizer=None, iters=None, epoch=None, meta_data=None, category=None, num_structure_points=None, multi_distribution=None,offset=None):
    ...
    state = {
        ...
        'meta_data': meta_data,
        'category': category,
        'num_structure_points': num_structure_points,
